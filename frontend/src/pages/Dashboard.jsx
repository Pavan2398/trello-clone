                ...
                <form onSubmit={handleCreateBoard} className="flex flex-col h-full justify-between">
                  <div>
                    ...
                    <input
                      ...
                      onBlur={() => !newBoardTitle && !creatingBoard && setIsCreating(false)}
                  ...
                  <div className="flex gap-2 justify-end mt-4">
                    <Button
                      ...
                      type="submit"
                      disabled={creatingBoard}
                      className="bg-indigo-600 hover:bg-indigo-700 h-8 text-xs disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                      {creatingBoard ? (
                        <>
              ...
              >
                ...
                <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity z-10">
                  <button
                    ...
                    className="p-1.5 bg-white/20 hover:bg-red-600 text-white rounded-md backdrop-blur-sm transition-colors"
                    title="Delete Board"
                  >
