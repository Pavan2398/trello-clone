          ...
          {(dueDate || totalChecklistItems > 0 || card.description || cardMembers.length > 0) && (
            <div className="flex items-center justify-between gap-2 pt-1 mt-1">
              <div className="flex items-center gap-2 flex-wrap text-slate-500">
                ...
                {dueDate && (
                  <div
                    className={`flex items-center gap-1 p-0.5 px-1.5 rounded text-[10px] font-semibold transition-colors ${card.is_due_complete
                    ...
                    title={card.is_due_complete ? 'Completed' : (isOverdue ? 'Overdue' : 'Due Date')}
                  >
                ...
                {totalChecklistItems > 0 && (
                  <div className={`flex items-center gap-1 p-0.5 px-1.5 rounded text-[10px] font-medium transition-colors ${completedChecklistItems === totalChecklistItems
